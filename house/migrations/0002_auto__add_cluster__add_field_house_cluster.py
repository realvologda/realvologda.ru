...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('house_cluster', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('geometry', self.gf('django.db.models.fields.TextField')(max_length=250, blank=True)),
        ))
        db.send_create_signal('house', ['Cluster'])

        # Adding field 'House.cluster'
        db.add_column('house_house', 'cluster',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['house.Cluster'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Cluster'
        db.delete_table('house_cluster')

        # Deleting field 'House.cluster'
        db.delete_column('house_house', 'cluster_id')
